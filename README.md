...
## ✨ Key Features
- 📈 Demand Forecasting (LSTM + XGBoost Ensemble)
- 👥 Customer Churn Prediction (XGBoost + LightGBM)
- 🧩 Customer Segmentation (KMeans, GMM)
...
```text
Data → Feature Engineering → ML Models → FastAPI → Dashboard → Monitoring